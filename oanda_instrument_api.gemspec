...
Gem::Specification.new do |s|
  s.name          = 'oanda_instrument_api'
  s.version       = OandaInstrumentApi::VERSION
  s.date          = Date.today.to_s
  s.authors       = ['Kobus Joubert']
  s.email         = ['kobus@translate3d.com']

  s.summary       = %q{Ruby Oanda Instrument API}
  s.description   = %q{Ruby client that supports the Oanda Instrument API methods.}
  s.homepage      = 'https://github.com/kobusjoubert/oanda_instrument_api'
