module OandaInstrumentApi
  class Api
    ...
    attr_accessor :client, :base_uri, :headers, :last_action, :last_arguments
    ...
    def initialize(options = {})
      ...
      raise OandaInstrumentApi::ApiError, 'No client object was supplid.' unless client
      ...
      when :show, :create, :update, :cancel, :close
        ...
        if respond_to?(last_action)
          ...
          begin
            ...
            raise OandaInstrumentApi::RequestError, e.message
          end
