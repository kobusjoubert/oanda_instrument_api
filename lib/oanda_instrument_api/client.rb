module OandaInstrumentApi
  class Client
    ...
    BASE_URI = {
      production:  'https://oandainstrument.herokuapp.com',
      staging:     'https://oandainstrument-staging.herokuapp.com',
      development: 'http://localhost:3200',
      backtest:    'http://localhost:3201'
    }

    attr_accessor :email, :authentication_token, :proxy_url, :max_requests_per_second, :connection_pool_size, :debug
